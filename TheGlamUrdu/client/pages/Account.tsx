          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12 animate-slide-up">
              <h1 className="text-5xl sm:text-6xl font-bold text-white mb-6">
                میرا <span className="text-purple-500">اکاؤنٹ</span>
              </h1>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-8 sm:p-12 space-y-6 animate-fade-in">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl font-bold text-white">ڈیش بورڈ</h2>
              </div>

              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                <p className="text-xl text-white/90 mb-6">موبائل نمبر نہیں ملا۔</p>
              ...
              <div className="mt-8 pt-6 border-t border-white/20">
                <p className="text-white/70 text-center">
                  کیا آپ کا اکاؤنٹ نہیں ہے؟ اپنے ڈیش بورڈ تک رسائی اور سبسکرپشن مینیج کرنے کے لیے سائن اِن کیجیے۔
                </p>
              </div>
            </div>
          </div>
